...
class SearchCenter(object):
    def __init__(self):
        ...
        self._time1 = datetime.time(0,0,0)
        self._time2 = datetime.time(23,59,59)
    ...
    def post_date_period(self, date1, date2):
        return datetime.datetime.combine(date1, self._time1), datetime.datetime.combine(date2, self._time2)
    
    def post_date_period2(self, date1, date2, time1, time2):
        return (datetime.datetime.combine(date1, time1)-datetime.timedelta(seconds=60)), (datetime.datetime.combine(date2, time2)+datetime.timedelta(seconds=60))
