...
model = model_dict['CBAM']()
criterion = nn.MSELoss()
optimizer = torch.optim.Adam(model.parameters(), lr=0.01)
params = torch.load(f"best_model/{'CBAM'}_best.pth")
...
print(plt.savefig(f"result_picture/{'CBAM'}_fic.jpg"))
print("{}'s eval loss is {}".format('CBAM', eval_loss / len(test_loader)))